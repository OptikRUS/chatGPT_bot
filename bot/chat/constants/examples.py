...
IMAGE_VARIATION: str = """
Отправьте документ формата 'png', а так же он должен соответствовать следующим параметрам:
 - Не больше 4 МБ
 - Размер должен соответстсовать квадрату, например 1024x1024
 Подсказка: При отправке документа уберите галочку с "Сжать изображение".
"""