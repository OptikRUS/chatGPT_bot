...
class PydanticConfigValidate(BaseSettings):
    class Config:
        env_file = ".env"
        env_file_encoding = "utf-8"


class BranchValidate(PydanticConfigValidate):
...
class BotSettings(PydanticConfigValidate):
...
class PollingSettings(PydanticConfigValidate):
...
class ChatApiSettings(PydanticConfigValidate):
